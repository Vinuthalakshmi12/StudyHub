  ...
  return (
    <div className="h-screen w-screen overflow-y-scroll">
      ...
      <div className="mt-[50px] mx-[50px] flex flex-row justify-between">
        ...
        <div className="mr-[50px] flex flex-col gap-6 items-center">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-[30px] text-emerald-500 font-bold ">
          ...
          <div className="flex flex-row items-center">
            ...
            <Link href={"/signin"}>
              {" "}
              <button className="h-14 px-[10px] pr-[30px]  font-bold text-white bg-gradient-to-t from-[#00E18F] to-[#3EB489] flex flex-row items-center gap-2">
                GET STARTED <BiRightArrow size="1rem"></BiRightArrow>{" "}
              </button>
            </Link>
          </div>
        </div>
      ...
      <div className="flex flex-row gap-8 justify-center">
        ...
        <FCard
          image="/fc2.png"
          title="Unlimited Adaptive Practice"
          content="
        ...
        <FCard
          ...
          content="
                                    ...
                                    pattern. You can study as per your schedule."
        />{" "}
      </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col ">
            ...
            <input
              ...
              className="border-[1px] rounded-sm border-emerald-400 px-[10px] py-[10px]"
            ></input>
          </div>
          <div className="flex flex-col ">
            ...
            <textarea
              ...
              className="border-[1px] w-[400px] rounded-sm border-emerald-400 px-[10px] py-[10px]"
            ></textarea>
          </div>
        </div>
        <div className="flex flex-col ">
          ...
          <input
            ...
            className="border-[1px] rounded-sm border-emerald-400 px-[10px] py-[10px] w-[400px]"
          ></input>
        </div>
      </div>
      ...
      <div className="bg-black flex flex-col items-center py-[20px]">
        ...
        <h1 className="text-gray-500 text-[12px]">
          StudyHub is a website where you can find the best Study materials
          Anytime, Anywhere.
        </h1>
